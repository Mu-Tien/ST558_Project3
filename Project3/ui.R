  ...
  tabsetPanel(
    tabPanel("Information",
             verticalLayout(
               ...
               "If you are only interested about the result, I recommend you to choose tree based model, and do the prediction after training the model,
               because these model has the highest accuracy at all time",
               h4("5. Data saving"),
